      ...
      <div className="flex flex-col space-y-6 p-6 md:p-20">
        ...
        <div className="mt-16 flex items-center justify-center gap-4">
          <button
            ...
            disabled={currPage === 1}
            className="rounded-xl border border-black bg-[#FFB0D8] px-4 py-2 font-medium text-black transition-colors duration-300 hover:bg-[#F6E18C] disabled:opacity-50 disabled:bg-gray-300 "
          >
            Previous
          </button>
          <span>
