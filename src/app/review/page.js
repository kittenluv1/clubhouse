    ...
    try {
      ...
      if (data) {
        try {
          ...
          if (!response.ok) {
            throw new Error(
              `Failed to call edge function: ${response.statusText}`
            );
          }
      ...
      <div className="max-w-4xl mx-auto font-dm-sans">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center">
            ...
            <label
              htmlFor="member"
              className="font-bold ml-2 block text-sm text-gray-700"
            >
          ...
          {/* Ratings */}
          <div>
            <label className="block text-sm font-bold text-gray-700 mt-10 mb-4">
              Rank the Following... <span className="text-red-500">*</span>
            </label>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="flex flex-col items-center space-y-1">
                <div className="w-10 h-10 rounded-full bg-purple-100 flex items-center justify-center mb-4">
                  ...
                  >
                    <path
                      d="M20 5.1582C28.2843 5.1582 35 12.0872 35 20.6338C34.9998 29.1802 28.2841 36.1084 20 36.1084C11.7159 36.1084 5.00024 29.1802 5 20.6338C5 12.0872 11.7157 5.1582 20 5.1582ZM20 10.1768C19.4477 10.1768 19 10.6245 19 11.1768V20.3838C19.0002 21.0739 19.5598 21.6338 20.25 21.6338H25.833L25.9355 21.6289C26.4397 21.5777 26.8328 21.1514 26.833 20.6338C26.833 20.116 26.4398 19.6899 25.9355 19.6387L25.833 19.6338H21V11.1768C21 10.6245 20.5523 10.1768 20 10.1768Z"
                      fill="#222222"
                    />
                  </svg>
                </div>
                <span className="text-xs font-medium text-green-800 mb-3">
                  Time Commitment
                </span>
              ...
              <div className="flex flex-col items-center space-y-1">
                <div className="w-10 h-10 rounded-full bg-pink-100 flex items-center justify-center mb-4">
                  ...
                  >
                    ...
                    <path
                      d="M28.334 22.1667C32.8461 22.1671 34.3661 27.1536 34.8232 29.4119C34.9406 29.9916 34.487 30.4996 33.8955 30.4998H29.2793C28.6075 27.984 27.3097 25.1301 24.7979 23.4998C25.7013 22.702 26.8572 22.1667 28.334 22.1667Z"
                      fill="#33363F"
                    />
                    <path
                      d="M11.6665 22.1667C13.1429 22.1667 14.2973 22.7024 15.2007 23.4998C12.6895 25.1302 11.3929 27.9844 10.7212 30.4998H6.105C5.51337 30.4998 5.05891 29.9917 5.17628 29.4119C5.63345 27.1536 7.15397 22.1668 11.6665 22.1667Z"
                      fill="#33363F"
                    />
                    <path
                      d="M19.9998 23.8333C26.7064 23.8333 28.0156 30.3101 28.2712 32.8388C28.3267 33.3883 27.8855 33.8333 27.3332 33.8333H12.6665C12.1142 33.8333 11.673 33.3883 11.7285 32.8388C11.9841 30.3101 13.2933 23.8333 19.9998 23.8333Z"
                      fill="#33363F"
                    />
                  </svg>
                </div>
